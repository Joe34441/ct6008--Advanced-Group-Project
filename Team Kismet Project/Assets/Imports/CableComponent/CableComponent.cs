...
//**********************************************************//
//NOT made by Team Kismet
//available at: https://github.com/NoxWings/Cable-Component
//**********************************************************//
public class CableComponent : MonoBehaviour
{
	...
	public void SetEndLocation(Vector3 newEnd)
    {
		endPoint.position = newEnd;
    }

	public void SetEndLocation(Transform newEnd)
    {
		endPoint = newEnd;
    }
